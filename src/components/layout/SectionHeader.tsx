  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="xl:text-sectiontitle3 mx-auto mb-4 text-3xl font-bold text-black dark:text-white md:w-4/5">
          {subtitle}
        </h2>
        <p className="mx-auto text-left md:w-4/5 lg:w-4/5 xl:w-[70%]">
          {description}
        </p>
      </motion.div>
      {/* <!-- Section Title End --> */}
